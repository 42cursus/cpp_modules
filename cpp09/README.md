...
### ex01:
    Polish notation (PN)
    (also known as normal Polish notation (NPN), Polish prefix notation or simply prefix notation)
    is a mathematical notation in which operators precede their operands, in contrast to the more common infix notation,
    in which operators are placed between operands, as well as reverse Polish notation (RPN),
